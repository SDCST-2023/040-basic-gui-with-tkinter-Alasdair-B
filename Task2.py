...
style = Style()
style.configure('TEnter', borderwidth = '3', relief=GROOVE,width=2)
style.configure('TLabel', font=(BOLD,11),background='#FFFFFF')
...
Button(window,text='Search by Name').grid(column=4,row=1)
Entry(window).grid(column=5,row=1,sticky='w')
...
Entry(window).grid(column=1,row=5,padx=3)
Entry(window).grid(column=2,row=5,padx=3)
Entry(window).grid(column=3,row=5,padx=3)
Entry(window).grid(column=4,row=5,padx=3)
Entry(window).grid(column=5,row=5,padx=3)
Button(window,text='< Previous').grid(column=1,row=6,sticky='w',padx=3,pady=3)
Button(window,text='Save Entry').grid(column=3,row=6,padx=3,pady=3)
